...
class PerformanceMeasureTest {
  ...
  void active_system_property() {
    ...
    assertThat(logTester.logs(LoggerLevel.INFO)).contains("" +
      ...
      "  {perf} /root ( 1,278,915 micro_s during 1 call(s))\n" +
      "  {perf} /root/root/cat-1 ( 1,195,595 micro_s during 1 call(s), minus children duration 261,017 micro_s )\n" +
      "  {perf} /root/root/cat-1/sub-cat-1 ( 234,453 micro_s during 1 call(s))\n" +
      "  {perf} /root/root/cat-1/sub-cat-2 ( 700,123 micro_s during 1 call(s))\n" +
      "  {perf} /root/root/cat-2 ( 83,320 micro_s during 1 call(s), minus children duration 48,866 micro_s )\n" +
      "  {perf} /root/root/cat-2/sub-cat-1 ( 32,553 micro_s during 1 call(s))\n" +
      "  {perf} /root/root/cat-2/sub-cat-2 ( 1,900 micro_s during 1 call(s))\n");
  }
